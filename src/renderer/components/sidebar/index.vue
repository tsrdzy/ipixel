<template>
    <aside>
        ...
        <nav class="top">
            <div class="iconfont btn" :class="router.currentRoute.value.path == '/local' ? 'active' : ''"
                @click="navigateTo('/local')">
                &#xeb1a;
            </div>
            <div class="iconfont btn" :class="router.currentRoute.value.path == '/store' ? 'active' : ''"
                @click="navigateTo('/store')">
                &#xeafd;
            </div>
            <div class="iconfont btn" :class="router.currentRoute.value.path == '/tools' ? 'active' : ''"
        ...
        <nav class="bottom">
            ...
            <el-dropdown popper-class="sidebar_dropdown" :show-arrow="false" size="small" trigger="click">
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <el-dropdown-item>创建资源库</el-dropdown-item>
                        <el-dropdown-item>打开资源库</el-dropdown-item>
        ...
        <el-dialog v-model="issetting" title="设置" width="50%" align-center>
            <Tsettings></Tsettings>
        </el-dialog>
        <el-dialog v-model="ischeckupdates" title="检查更新" width="300" align-center>
            <Tcheckupdates></Tcheckupdates>
        </el-dialog>
        <el-dialog v-model="isabout" title="关于ipixel" width="300" align-center>
            <Tabout></Tabout>
        </el-dialog>
    </aside>
</template>
